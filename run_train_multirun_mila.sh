...
# cpu, each sweep contains 4x2=8 runs
# num_domains=2
# python run_training.py ckpt_path=null model/optimizer=adam model.optimizer.lr=0.001 datamodule/dataset=multi_domain_mnist model=mnist_md_autoencoder model.penalty_criterion="minmax" model.hinge_loss_weight=0.0 model.autoencoder.num_channels=3 model.z_dim=8,16,32,64 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" datamodule.dataset.num_domains=2 model.penalty_weight=1.0,0.1 logger.wandb.tags=["mila","sweep-mnist-minmax-nohinge"] --multirun
# num_domains=4
# python run_training.py ckpt_path=null model/optimizer=adam model.optimizer.lr=0.001 datamodule/dataset=multi_domain_mnist model=mnist_md_autoencoder model.penalty_criterion="minmax" model.hinge_loss_weight=0.0 model.autoencoder.num_channels=3 model.z_dim=8,16,32,64 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" datamodule.dataset.num_domains=4 model.penalty_weight=1.0,0.1 logger.wandb.tags=["mila","sweep-mnist-minmax-nohinge"] --multirun
# num_domains=8
...
# cpu, each sweep contains 4x3x2=24 runs
# num_domains=2
