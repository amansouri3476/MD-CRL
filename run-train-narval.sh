...
# python run_training.py trainer.accelerator='gpu' trainer.gradient_clip_val=0.1 trainer.devices=1 ckpt_path=null model/optimizer=adamw model.optimizer.lr=0.0001 datamodule=md_balls datamodule.dataset.n_balls_invariant=1 datamodule.dataset.n_balls_spurious=1 model=balls model.z_dim=128 model/autoencoder=cnn_ae_balls model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls","cnn"] ~callbacks.early_stopping

# cnn with bn
# python run_training.py trainer.accelerator='gpu' trainer.gradient_clip_val=0.1 trainer.devices=1 ckpt_path=null model/optimizer=adamw model.optimizer.lr=0.001 datamodule=md_balls datamodule.dataset.n_balls_invariant=1 datamodule.dataset.n_balls_spurious=1 model=balls model.z_dim=128 model/autoencoder=cnn_ae_balls model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls","cnn-bn"] ~callbacks.early_stopping

# resnet18
python run_training.py trainer.accelerator='gpu' trainer.gradient_clip_val=0.1 trainer.devices=1 ckpt_path=null model/optimizer=adamw model.optimizer.lr=0.0001 datamodule=md_balls datamodule.dataset.n_balls_invariant=1 datamodule.dataset.n_balls_spurious=1 model=balls model.z_dim=128 model/autoencoder=resnet18_ae_balls model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls","resnet-bn"] ~callbacks.early_stopping
...
# python run_training.py trainer.accelerator='cpu' trainer.gradient_clip_val=0.1 ckpt_path=null model/optimizer=adamw model.optimizer.lr=0.001 datamodule=md_balls datamodule.dataset.n_balls_invariant=1 datamodule.dataset.n_balls_spurious=1 model=balls model.z_dim=64 model/autoencoder=resnet18_ae_balls model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls","test"] ~callbacks.early_stopping
...
# iv=1,sp=1
# cpu
python run_training.py ckpt_path=null trainer.accelerator='cpu' model.optimizer.lr=0.001 datamodule=balls_encoded model=balls_md_encoded_autoencoder model.z_dim=64 model.z_dim_invariant_fraction=0.5 model.hinge_loss_weight=0.0 model.penalty_criterion="minmax" model.penalty_weight=1.0 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls-encoded"] ~callbacks.early_stopping ~callbacks.visualization_callback run_path="/home/aminm/scratch/logs/training/runs/autoencoder_md_balls_128_iv_1_sp_1/2023-09-19_12-29-50" ckpt_path=null
python run_training.py ckpt_path=null trainer.accelerator='cpu' model.optimizer.lr=0.001 datamodule=balls_encoded model=balls_md_encoded_autoencoder model.z_dim=64 model.z_dim_invariant_fraction=0.5 model.hinge_loss_weight=0.0 model.penalty_criterion="minmax" model.penalty_weight=1.0 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls-encoded"] ~callbacks.early_stopping ~callbacks.visualization_callback run_path="/home/aminm/scratch/logs/training/runs/autoencoder_md_balls_128_iv_1_sp_1/2023-09-19_13-15-09" ckpt_path=null
python run_training.py ckpt_path=null trainer.accelerator='cpu' model.optimizer.lr=0.001 datamodule=balls_encoded model=balls_md_encoded_autoencoder model.z_dim=64 model.z_dim_invariant_fraction=0.5 model.hinge_loss_weight=0.0 model.penalty_criterion="minmax" model.penalty_weight=1.0 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls-encoded"] ~callbacks.early_stopping ~callbacks.visualization_callback run_path="/home/aminm/scratch/logs/training/runs/autoencoder_md_balls_128_iv_1_sp_1/2023-09-19_13-55-42" ckpt_path=null

python run_training.py ckpt_path=null trainer.accelerator='cpu' model.optimizer.lr=0.001 datamodule=balls_encoded model=balls_md_encoded_autoencoder model.z_dim=64 model.z_dim_invariant_fraction=0.5 model.hinge_loss_weight=0.0 model.penalty_criterion="minmax" model.penalty_weight=1.0 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","balls-encoded"] ~callbacks.early_stopping ~callbacks.visualization_callback run_path="/home/aminm/scratch/logs/training/runs/autoencoder_md_balls_128_iv_1_sp_1/2023-09-19_14-03-08" ckpt_path=null

# domain classification loss
python run_training.py ckpt_path=null trainer.accelerator='cpu' model.optimizer.lr=0.001 datamodule=balls_encoded model=balls_md_encoded_autoencoder model.z_dim=128 model.z_dim_invariant_fraction=0.5 model.hinge_loss_weight=0.0 model.penalty_criterion="domain_classification" model.penalty_weight=1.0 model/scheduler_config=reduce_on_plateau model.scheduler_config.scheduler_dict.monitor="train_loss" logger.wandb.tags=["narval","domain_classification"] ~callbacks.early_stopping ~callbacks.visualization_callback run_path="/home/aminm/scratch/logs/training/runs/autoencoder_md_balls_128_iv_1_sp_1/2023-09-19_16-57-50" ckpt_path=null
# ------------------------------------------------------------------------------------- #
# --------------------------------------- MNIST --------------------------------------- #
# ------------------------------------------------------------------------------------- #
